const projects = [
    {
      ...
      description: 'An independent online platform for Kenyan Trending news in Entertainment, Politics, Lifestyle and Business. It is built with sveltekit and styled with TailwindCSS. Posts are pulled from GraphCMS with the help of GraphQL queries.',
      features: [
    ...
    },
    {
      ...
      coverImage: '/images/projects/taarifa.jpeg',
      description: 'Sveltekit blog is a markdown powered blog (the one you are currently on). It utilises sveltekit load function to pull posts and projects from sveltekit endpoints.',
      features: [
