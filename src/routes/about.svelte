...
<div class="about">
	...
	<p>
		Hello, I am a Front End Developer with some knowledge of the Back End. I occassionaly write
		about some topics that arise as I go through my journey as a software developer.
	</p>
	...
	<p>
		I am currently working on the <em>Deep Dive into Modern Web Development</em> online course offered
		by The University of Helsinki. It is a hands on course where I learn by building stuff. I have so
		far covered:
	</p>
	...
	<p>
		The rest of the course covers Testing, State Management with Redux, Webpack, custom hooks,
		GraphQL, TypeScript, React Native, CI/CD, Containers and Relational Databases.
	</p>

	<p>
		I would love an opportunity to collaborate in <strong
			>ReactJS (NextJS), SveltJS (SvelteKit), MERN</strong
		>
		projects and the <strong>JavaScript</strong> eco-system which I find to be very broad && diverse.
		I will write about the above topics among others so stay tuned!
	</p>
